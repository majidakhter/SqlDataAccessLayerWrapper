//------------------------------------------------------------------------------ 
// <copyright file="SqlFrameworkCommandBuilder.cs" company="AromaCareGlow LLP">
...
namespace AromaCareGlow.Framework.DataAccess.Factory.Accessors
{
    /// <summary>
    ///		This class is used to build sql queries and SQL command objects.
    /// </summary>
