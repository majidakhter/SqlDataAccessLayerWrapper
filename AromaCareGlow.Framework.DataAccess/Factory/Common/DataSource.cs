//------------------------------------------------------------------------------ 
// <copyright file="DataSource.cs" company="AromaCareGlow LLP">
...
namespace AromaCareGlow.Framework.DataAccess.Factory.Common
{
    /// <summary>
    ...
    public class DataSource
    {
        ...
        public string GetConnectionString()
        {
            ...
            {
                throw new ApplicationException("Connection string not found in configuration file", ex);
            }
