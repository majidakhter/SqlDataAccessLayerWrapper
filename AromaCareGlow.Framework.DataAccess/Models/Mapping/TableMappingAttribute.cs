//------------------------------------------------------------------------------ 
// <copyright file="TableMappingAttribute.cs" company="AromaCareGlow LLP">
...
namespace AromaCareGlow.Framework.DataAccess.Models.Mapping
{
    ...
    public sealed class TableMappingAttribute : Attribute
    {
        ...
        /// <summary>
        /// Gets the name of the database table used for insert and update statements.
        /// TableName is used for insert and update statements.
        ...
        /// <summary>
        /// Gets the name of the view or table used for select statements.
        /// The model may be read from a view but written to a table. The view name specifies
        /// the database structure that will be queried from select statements. If the view name
