//------------------------------------------------------------------------------ 
// <copyright file="ProcedureMappingAttribute.cs" company="AromaCareGlow LLP">
...
namespace AromaCareGlow.Framework.DataAccess.Models.Mapping
{
    ...
    public class StoredProcedureMappingAttribute : Attribute
    {
        ...
        /// <summary>
        ///     Gets the name of the database procedure used for insert statements.
        ///     Procedure name is used for insert and update statements.		
        /// </summary>
